...
use super::item::{EquippableItem, Item, ItemType};
...
pub fn armor() -> &'static HashMap<&'static str, Item<'static, EquippableItem>> {
    static HASHMAP: OnceLock<HashMap<&'static str, Item<EquippableItem>>> = OnceLock::new();
    HASHMAP.get_or_init(|| {
...
// pub static ARMOR: phf::Map<&'static str, Item<EquippableItem>> = phf_map! {
