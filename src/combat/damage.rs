//! Basic-attack damage formula, shared by the combat appraiser and the GUI.
//!
//! Lifted verbatim from the GUI helper so the decision layer and the on-screen
//! damage readout compute from a single source of truth.
